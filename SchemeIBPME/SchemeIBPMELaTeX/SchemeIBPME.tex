...
generate $x, \alpha \in \mathbb{Z}_p^*$ randomly
...
generate $\bar{x} \in \mathbb{Z}_p^*$ randomly
...
\subsection{$\textbf{Dec}_2(\textit{dk}_{\textit{id}_3}, \textit{id}_1, \textit{id}_2, \textit{ct}') \rightarrow m$}
